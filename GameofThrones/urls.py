...
urlpatterns = [
    ...
    url(r'^delete_house/',views.delete_character,name='delete_character'),
    url(r'^add_battle/',views.add_battle,name='add_battle'),
    url(r'^delete_battle/',views.delete_character,name='delete_character'),
]
